...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layadmin-user-login-main">
        ...
        <form action="/user/auth/sign-in" method="post" class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <div class="layui-form-item">
                ...
                <input type="text" name="email" id="LAY-user-login-email" lay-verify="email" placeholder="邮箱" class="layui-input" value="{{old('email')}}">
            </div>
            <!--密码-->
            <div class="layui-form-item">
    ...
    <div class="ladmin-user-login-theme">
          <script type="text/html" template>
            <ul>
              <li data-theme=""><img src="/static/layuiadmin/style/res/bg-none.jpg"></li>
