            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-auto category-breadcrumb">
                                        ...
                                        @if ($category)
                                            ...
                                            <span></span>
                                            <!-- 当前类目的ID，当用户调整排序方式时，可以保证$category_id 参数不丢失 -->
                            ...
                            <div class="col-md-3">
                                <select name="order" class="form-control form-control-sm float-right">
                                    ...
                                    <option vlaue="rating_asc">评价从低到高</option>
                                    ...
                                    <div class="top">
                                        <div class="img">
                                            <a href="{{route('products.show',['product'=>$product->id])}}">
                                                ...
                                                {{-- laravel的模型访问器会自动将下划线改为驼峰，对应的就是getImageUrlAttritube --}}
                                            </a>
                                        </div>
                                        <div class="price">
                                            <b>￥</b>{{$product->price}}
                    ...
                    <div class="float-right">
                        ...
                        {{-- 与 $products->appends($filters)->links() 显示效果相同 --}}
                        {{-- links()方法会将结果集中的其他页面链接渲染出来，render()方法生成的HTML兼容Bootstrap CSS框架}}
                        {{-- appends()方法，添加查询参数到每个分页链接查询字符串,因此$products必须是分页处理后的对象（如：paginate（16）） --}}
                    </div>
                </div>
            </div>
        </div>
...
@section('scriptsAfterJs')
    <script>
        ...
        {{-- 把控制器传过来的$filters变量变成一个JSON字符串，赋值给JS的filters变量 --}}
