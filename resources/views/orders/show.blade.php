                    ...
                    <table class="able">
                        ...
                        @foreach($order->items as $index=>$item)
                            <tr>
                                ...
                                <td class="item-amount text-center vertical-middle">
                        ...
                        <div class="order-summary text-right">
                            ...
                            @if(!$order->paid_at && !$order->closed)
                                <div class="payment-buttons">
                                    ...
                                    <!-- 分期支付按钮 -->
                                    <!-- 当且仅当订单总金额大于等于分期最低金额是才展示分期按钮 -->
                                    @if($order->total_amount >= config('app.min_installment_amount'))
                                        <button class="btn btn-sm btn-danger" id="btn-installment">
                                            分期付款
                                        </button>
                                    @endif
                                </div>
                            ...
                            @if($order->ship_status === \App\Models\Order::SHIP_STATUS_DELIVERED)
                                <div class="receive-button">
                                    <button type="button" id="btn-receive" class="btn btn-sm btn-success">
                                        确认收货
                                    </button>
                                </div>
                            @endif
                            <!-- 订单已支付，且退款状态为未退款时展示申请退款按钮 -->
                            @if($order->paid_at && $order->refund_status === \App\Models\Order::REFUND_STATUS_PENDING)
