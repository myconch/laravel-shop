    ...
    <div class="box-body">
        <table class="table table-bordered">
            ...
            <tr>
                <td>收货地址</td>
                <td colspan="3">
                    {{$order->address['address']}}  {{$order->address['zip']}}  {{$order->address['contact_name']}}  {{$order->address['contact_phone']}}
                </td>
            </tr>
            <tr>
                ...
                <tr>
                    <td colspan="4">
                        <form action="{{route('admin.orders.ship',[$order->id])}}" method="post" class="form-inline">
                            ...
                            <button type="submit" class="btn btn-success" id="ship-btn">
                                发货
                            </button>
                        </form>
                    </td>
...
<script>
    $(document).ready(function(){
        ...
        $('#btn-refund-disagree').click(function(){
            //laravel-admin 使用的SweetAlert版本与前台的版本不一样，因此参数也不太一样
            swal({
                title:'输入拒绝退款的理由',
                input:'text',
                ...
                preConfirm: function(inputValue) {
                    ...
                    //laravel-admin 没有axios ，因此使用ajax
                    return $.ajax({
                        ...
                        data:JSON.stringify({
                            ...
                            reason:inputValue,
                            //带上CSRF Token
                            //laravel-admin 页面可以通过LA.token 获得CSRF　Token
                            _token:LA.token,
                        }),
