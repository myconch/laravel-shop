                ...
                <div class="card-body">
                    <div class="installment-top">
                        ...
                        <div class="installment-next text-right">
                            ...
                            @if(is_null($nextItem))
                                <div class="installment-clear text-center">
                                    此订单已结清
                                </div>
                            @else
                                <div>
                                    <span>近期待还：</span>
                                    <div class="value total-amount">
                                        ￥{{$nextItem->total}}
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="payment-buttons">
                                    <a class="btn btn-primary btn-sm" href="{{route('installments.alipay',['installment'=>$installment->id])}}">
                                        支付宝支付
                                    </a>
                                </div>
                            @endif
